...
if ($cdata2 == "back") {
    ...
    $videoUrl = "https://t.me/slatt_bio/3";
...
if ($cdata2 == "price") {
  ...
  ";
    ...
    $priceKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => ' 𝙃𝙤𝙢𝙚 🏡 ', 'callback_data' => 'back2'], ['text' => '[🜲] 𝙊𝙬𝙣𝙚𝙧', 'url' => 'https://t.me/spiderslatt']]
        ]
    ]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "🌧 Owner 🌧 ", 'url' => "https://t.me/spiderslatt"], ['text' => "💥 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 💥", 'url' => "t.me/spiderslatt"]],
...
");
    ...
    // Change this to your video url
    $backVideoUrl = "https://t.me/slatt_bio/3"; 
    ...
    $keyboard2 = json_encode([
        'inline_keyboard' => [
                             ...
                             ['text' => '[🜲] 𝙊𝙬𝙣𝙚𝙧 ', 'url' => 'https://t.me/spiderslatt'],
                             ['text' => 'Channel', 'url' => 't.me/spiderslatt']
                                              ],
                                       ]
                                                ]);
